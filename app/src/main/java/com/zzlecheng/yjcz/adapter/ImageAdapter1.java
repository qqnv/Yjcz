...
public class ImageAdapter1 extends RecyclerView.Adapter<ImageAdapter1.ViewHolder> {
    ...
    public ImageAdapter1(Context context, List<ReportPictureBean> pictureBeans) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        if (pictureBeans.size() > 4) {
            ReportPictureBean bean = pictureBeans.get(position + 4);
