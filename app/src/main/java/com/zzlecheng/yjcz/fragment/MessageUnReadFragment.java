 ...
 * @版本: 1.0.0
 */
public class MessageUnReadFragment extends BaseFragment {
    ...
    private void getMessage() {
        HttpMethods.getHttpMethods().getMessage(getActivity(), userId, "0", "0",
    ...
    private void commitMessage(String id) {
        HttpMethods.getHttpMethods().commitMessage(getContext(), id, "1", "0",
