 ...
 * @版本: 1.0.0
 */
public class VideoRecordChatActivity extends BaseActivity implements TextureView.SurfaceTextureListener {
    //视图控件
    ...
    private MediaRecorder.OnErrorListener onErrorListener = new MediaRecorder.OnErrorListener() {
        ...
        public void onError(MediaRecorder mr, int what, int extra) {
            try {
                ...
                Toast.makeText(VideoRecordChatActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    protected void initView() {
        ...
        TextView tvCommit = findViewById(R.id.tv_updates);
    ...
    private void commitVideo() {
        ...
        HttpMethods.getHttpMethods().commitChatFj(this, lclsid, soures, "1", userid,
                username, "0", new File(absolutePath),
                new BaseObserver<CommonBean>(this, false) {
                    @Override
                    protected void onHandleSuccess(CommonBean commonBean) {
                        ToastUtils.showShortToast(VideoRecordChatActivity.this, "视频发送成功");
                        finish();
                    }
                });
    }
